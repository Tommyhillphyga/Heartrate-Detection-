...
#Heart#Rate#Detection################################
        ...
        r1, g1, b1 = filtered[bufferIndex][10,10]
        ci = (r1+g1+b1)/3
        intensity_buffer.append(ci)
        standardized_value = standardize(ci, intensity_buffer)
...
def main():
    ...
    st.sidebar.markdown("**Beat Per Minute (BPM)**")
